...
When you ready to merge the branch to `main`, open a pull request, watch as the Cloudflare Pages build completes to allow your Merge, which will trigger a Production build and deployment!
